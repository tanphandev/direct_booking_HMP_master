...
import { getPublicRoomAvailableSuccess, getPublicRoomAvailableFailed } from './roomSlice';
...
export default function* RoomSaga() {
  yield all([takeLatest(roomAction.getPublicRoomAvailable, getPublicRoomAvailable)]);
}
