const Path = {
  ...
  FAQS: (hotel_slug: string) => `/${hotel_slug}/page/faqs`,
  ENGLIST_DEMO_TEST: (hotel_slug: string) => `/${hotel_slug}/page/english_test`,
  GET_PAGE_BY_NAME: (hotel_slug: string, page_name: string) => `/${hotel_slug}/page/${page_name}`,
